...
def main():
    try:
        ...
        if os.path.exists(excel_file):
            ...
            # map_name_apply_carto = val_dict['Data_prep_map_name_apply_carto']
            # map_name_resolve_lines = val_dict['Data_prep_map_name_resolve_lines']
            # map_name_resolve_polygons = val_dict['Data_prep_map_name_resolve_buildings']
            # map_name_detect = val_dict['Data_prep_map_name_detect_conflict']
            ...
            # Load data into sde config value
            versions = val_dict['Load_version']
        ...
        if theme_type == '1-Data Preparation':
            ...
            # Backup features data
            backup_path = os.path.join(log_dir, "Backup", "01-AFTDP", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "01-AFTDP", "Edit")
            ...
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "02-AFTTrans", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "03-AFTHydro", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "04-AFTBuiltUp", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "05-AFTUtil", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "06-AFTHypso", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            # Backup features data
            backup_path = os.path.join(log_dir, "Backup", "07-AFTVeg", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "07-AFTVeg", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            # # Backup Geodatabase
            backup_path = os.path.join(log_dir, "Backup", "08-AFTAS", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "08-AFTAS", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            # Backup features data
            ## Backup Geodatabase
            backup_path = os.path.join(log_dir, "Backup", "09a-AFTRCL", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "09a-AFTRCL", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            theme_09b_resolve_conflict_polygons.resolve_conflict_polygons(fc_list, build_up_area_fcs, input_building_layers, input_barrier_layers, symbology_file_path, g1_align_features, 
                            g4_align_features, g5_input_points, g5_align_features, g6_align_features, g7_input_points, g7_align_features, input_primary, input_secondary, working_gdb, imported_map.name, log_dir, val_dict, df_query_input_lyr_9b, logger)
            ...
            logger.info(f'Compacting geodatabase {in_feature_loc} was successful. Proceeding to backup...')
            # # Backup features data
            backup_path = os.path.join(log_dir, "Backup", "09b-AFTRCP", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "09b-AFTRCP", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            # # Process Validation
            theme_10_detect_conflict.run_gdb_audit_and_validation(in_feature_loc, "ValidatedGDB.gdb", "ValidationAuditReport.xlsx")
            
            logger.info(f'Detect Conflict Theme ran successfully. Starting Backup.....')
            # Backup features data
            backup_path = os.path.join(log_dir, "Backup", "10-AFTDC", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "10-AFTDC", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
            ...
            # Backup features data
            backup_path = os.path.join(log_dir, "Backup", "11-Final", "Auto")
            os.makedirs(backup_path, exist_ok=True)
            backup_path_edit = os.path.join(log_dir, "Backup", "11-Final", "Edit")
            os.makedirs(backup_path_edit, exist_ok=True)
